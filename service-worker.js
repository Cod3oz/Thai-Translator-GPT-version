const CACHE_NAME="thai-translator-cache-v9.0";
...
self.addEventListener("fetch",e=>{const req=e.request;const url=new URL(req.url);if(url.pathname.startsWith("/api/"))return;
